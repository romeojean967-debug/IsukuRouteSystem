...
-- Emails that are always granted the system administrator role
...
insert into public.admin_allowlist (email) values ('jeanromeo256@gmail.com') on conflict do nothing;
